...
public extension DatabaseManager {
    ...
    func saveOfflineOperation(_ operation: OfflineOperation) async throws {
    ...
    func updateOfflineOperation(_ operation: OfflineOperation) async throws {
    ...
    func deleteOfflineOperation(_ id: String) async throws {
    ...
    func deleteAllOfflineOperations() async throws {
        try connection.run(Tables.offlineOperations.delete())
    }

    /// Gets all pending operations
    func getPendingOperations() async throws -> [OfflineOperation] {
    ...
    func getOperationsByStatus(_ status: OfflineOperation.OperationStatus) async throws -> [OfflineOperation] {
        let query = Tables.offlineOperations
    ...
    func countOperationsByStatus(_ status: OfflineOperation.OperationStatus) async throws -> Int {
    ...
    func markExpiredOperationsFailed() async throws {
