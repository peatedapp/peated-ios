...
public enum Tables {
    // Users table
    public nonisolated(unsafe) static let users = Table("users")
    public enum Users {
    ...
    // Bottles table
    public nonisolated(unsafe) static let bottles = Table("bottles")
    public enum Bottles {
        nonisolated(unsafe) static let id = Expression<Int64>("id")
    ...
    // Tastings table
    public nonisolated(unsafe) static let tastings = Table("tastings")
    public enum Tastings {
        nonisolated(unsafe) static let id = Expression<Int64>("id")
    ...
    // Collection table
    public nonisolated(unsafe) static let collection = Table("collection")
    ...
    // Offline operations table
    public nonisolated(unsafe) static let offlineOperations = Table("offline_operations")
