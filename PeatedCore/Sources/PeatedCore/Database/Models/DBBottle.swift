...
extension DBBottle {
    ...
    static func from(row: Row) throws -> DBBottle {
        try DBBottle(
            id: row.get(Tables.Bottles.id),
            name: row.get(Tables.Bottles.name),
            brand: row.get(Tables.Bottles.brand),
            distillery: row.get(Tables.Bottles.distillery),
            category: row.get(Tables.Bottles.category),
            statedAge: row.get(Tables.Bottles.statedAge),
            caskStrength: row.get(Tables.Bottles.caskStrength),
            singleCask: row.get(Tables.Bottles.singleCask),
            createdAt: row.get(Tables.Bottles.createdAt),
            updatedAt: row.get(Tables.Bottles.updatedAt)
        )
    }
