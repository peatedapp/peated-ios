...
public extension DatabaseManager {
    ...
    internal func setupCacheTables() throws {
        // Feed cache table
    ...
    func cacheFeed(type: FeedType, items: [TastingFeedItem]) async throws {
    ...
    func getCachedFeed(type: FeedType) async throws -> CachedFeed {
    ...
    func clearFeedCache(type: FeedType) async throws {
    ...
    func cacheTasting(_ tasting: TastingFeedItem) async throws {
    ...
    func getCachedTasting(id: String) async throws -> CachedTasting? {
    ...
    func updateCachedTasting(_ tasting: TastingFeedItem) async throws {
    ...
    func pruneTastingCache(maxEntries: Int = 2000) async throws {
    ...
    func pruneTastingCache(olderThanDays days: Int) async throws {
