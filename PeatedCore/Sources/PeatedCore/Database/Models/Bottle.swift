...
/// Represents a whisky bottle
public struct Bottle: Codable {
  public let id: Int64
...
extension Bottle {
  ...
  static func from(row: Row) throws -> Bottle {
    Bottle(
  ...
  /// Find bottle by ID
  public static func find(_ id: Int64, in db: Connection) throws -> Bottle? {
  ...
  public static func search(name: String, in db: Connection) throws -> [Bottle] {
